...
class EAT_messageBox_Dialog
{
	...
	class Controls {
		...
		class EAT_msgBox_btnSend: EAT_RscShortcutButton
		{
			...
			onButtonClick = "EAT_SendDialogText = ctrlText ((ctrlParent (_this select 0)) displayCtrl 1400);((ctrlParent (_this select 0)) closeDisplay 9000);";
		};
...
class EAT_build_SuperAdminDialog
{
	idd = -1;
	movingenable = 0;
	...
	class Controls {
		...
		class EAT_build_btnCastle: EAT_RscShortcutButton
		{
			idc = 1710;
			text = "Castle";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Castle""] call LoadSpecificList;";
		};
		
		class EAT_build_btnEpoch: EAT_RscShortcutButton
		{
			idc = 1710;
			text = "Modular";
			x = 0.323404 * safezoneW + safezoneX;
			y = 0.579902 * safezoneH + safezoneY;
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Epoch""] call LoadSpecificList;";
		};
...
class EAT_build_AdminDialog
{
	...
	class Controls {
		...
		class EAT_build_btnCinder: EAT_RscShortcutButton
		{
			idc = 1702;
			text = "Cinder";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Cinder""] call LoadSpecificList;";
		};
		
		class EAT_build_btnWood: EAT_RscShortcutButton
		{
			idc = 1703;
			text = "Wood";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Wood""] call LoadSpecificList;";
		};
		
		class EAT_build_btnMetal: EAT_RscShortcutButton
		{
			idc = 1704;
			text = "Metal";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Metal""] call LoadSpecificList;";
		};
		
		class EAT_build_btnNets: EAT_RscShortcutButton
		{
			idc = 1705;
			text = "Camo Nets";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Nets""] call LoadSpecificList;";
		};
		
		class EAT_build_btnStorage: EAT_RscShortcutButton
		{
			idc = 1706;
			text = "Storage";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553564 * safezoneH;
			onButtonClick="[""Storage""] call LoadSpecificList;";
		};
		
		class EAT_build_btnSandbags: EAT_RscShortcutButton
		{
			idc = 1707;
			text = "Sandbags";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Sandbags""] call LoadSpecificList;";
		};
		
		class EAT_build_btnMisc: EAT_RscShortcutButton
		{
			idc = 1708;
			text = "Misc";
			x = 0.323404 * safezoneW + safezoneX;
			...
			w = 0.0706801 * safezoneW;
			h = 0.0553565 * safezoneH;
			onButtonClick="[""Misc""] call LoadSpecificList;";
		};
		class EAT_build_btnTemp: EAT_RscShortcutButton
		{
			idc = -1;
